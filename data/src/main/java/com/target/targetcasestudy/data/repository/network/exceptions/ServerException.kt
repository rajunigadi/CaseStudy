...
import com.target.targetcasestudy.data.repository.network.AppServerError
...
class ServerException internal constructor(
    ...
    public var serverError: AppServerError? = null
    ...
    init {
        if (response != null) {
            try {
                serverError = getErrorBodyAs(AppServerError::class.java)
